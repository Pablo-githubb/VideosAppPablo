    ...
    <div class="form-container">
        ...
        <form action="{{ route('videos.update', $video->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $video->title) }}" required data-qa="title">
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="4" required data-qa="description">{{ old('description', $video->description) }}</textarea>
                @error('description')
                    <div class="text-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="url" name="url" id="url" class="form-control" value="{{ old('url', $video->url) }}" required data-qa="url">
                @error('url')
                    <div class="text-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-submit" data-qa="btn-update-video">Actualitzar Vídeo</button>
            </div>
        </form>
    </div>
</x-videos-app-layout>
