    ...
    <div class="form-container">
        ...
        <form action="{{ route('series.manage.update', $serie->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="title" id="title" class="form-control" value="{{ old('title', $serie->title) }}" required data-qa="title">
                @error('title')
            ...
            <div class="form-group">
                ...
                <textarea name="description" id="description" class="form-control" rows="4" required data-qa="description">{{ old('description', $serie->description) }}</textarea>
                @error('description')
                    <div class="text-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="image" id="image" class="form-control" value="{{ old('image', $serie->image) }}" data-qa="image">
                @error('image')
                    <div class="text-error">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-submit" data-qa="btn-update-serie">Actualitzar Sèrie</button>
            </div>
        </form>
    </div>
</x-videos-app-layout>
